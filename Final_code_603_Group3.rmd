...
```{r}
inter_model_3_boxcox<-lm((((score^1.353535)-1)/1.353535)~growth_score+criminal_act+bullying+staff+media+salary_funds+pupil_funds+goal_met+factor(poverty_level)+factor(theater)+goal_met*factor(poverty_level)+media*factor(poverty_level)+staff*pupil_funds+bullying*staff+criminal_act*pupil_funds+growth_score*goal_met, data = final_data)
...
```{r}
inter_model_3_wt2_bc<-lm(((score^1.393939-1)/1.393939)~growth_score+criminal_act+bullying+staff+media+salary_funds+pupil_funds+goal_met+factor(poverty_level)+factor(theater)+goal_met*factor(poverty_level)+media*factor(poverty_level)+staff*pupil_funds+bullying*staff+criminal_act*pupil_funds+growth_score*goal_met, data = final_data, weights=wt2)
...
```{r}
inter_model_3_no_outlier_wt_bc<-lm(((score^1.393939-1)/1.393939)~growth_score+criminal_act+bullying+staff+media+salary_funds+pupil_funds+goal_met+factor(poverty_level)+factor(theater)+goal_met*factor(poverty_level)+media*factor(poverty_level)+staff*pupil_funds+bullying*staff+criminal_act*pupil_funds+growth_score*goal_met, data = WithoutOutliers, weights = wt)
